...
document.addEventListener("DOMContentLoaded", () => {
    // este es el numero maximo de pokemones xd
...
async function loadPokemon(id) {
  try {
    const [pokemon, pokemonSpecies] = await Promise.all([
     ...
     // extracciones de dartos de la api de pokemon
...
const typeColors = {
  ...
  ghost: "#705898",
  dragon: "#7038F8",
  dark: "#705858", // este color estaba mal en el original me parece
  steel: "#B8B8D0",
  fairy: "#EE99AC", // color mal colocado en el original, proboca errores
};
